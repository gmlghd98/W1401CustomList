...
class SongViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
        ...
        const val SERVER_URL = "https://wexpresssongdb-mtmmd.run.goorm.io"
    }
    ...
    //fun getImageUrl(i: Int): String = "$SERVER_URL/image/" + songs[i].image -> 이건 파일 이름이 영문일 때...
    ...
    fun requestSong() {
        ...
        //val url = "https://wexpresssongdb-mtmmd.run.goorm.io/song"
